...
// Hilfsklasse: So sieht unsere JSON-Datei f�r Unity aus
[Serializable]
...
{
    // Diese Variablen k�nnen von �berall im Projekt abgerufen werden
    public static string RosIp = "192.168.1.111";
