...
public class RobotStateReceiver : MonoBehaviour
{
    ...
    IEnumerator SubscribeGeneric()
    {
        ...
        Debug.Log("<color=yellow>[RobotStateReceiver] Subscribing to /servo_joint_target...</color>");
        RosConnector.Instance.Subscribe("/servo_joint_target", "sensor_msgs/msg/JointState", HandleMessage);
    }
